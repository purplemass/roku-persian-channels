This a a Roku dev channel that I'm experimenting
with to provide a few Persian speaking channels
for my parents.

It's still very mch work in progress but I'll be
updating it in the next few weeks.

This is based on the videoplayer example with its
README copy below.
